...
// 	protoc        v6.31.1
// source: github.com/buildbarn/bb-clientd/pkg/proto/configuration/bb_clientd/bb_clientd.proto
...
func (x *ApplicationConfiguration) Reset() {
	*x = ApplicationConfiguration{}
	mi := &file_github_com_buildbarn_bb_clientd_pkg_proto_configuration_bb_clientd_bb_clientd_proto_msgTypes[0]
...
func (*ApplicationConfiguration) Descriptor() ([]byte, []int) {
	return file_github_com_buildbarn_bb_clientd_pkg_proto_configuration_bb_clientd_bb_clientd_proto_rawDescGZIP(), []int{0}
}
...
func (x *OutputPathPersistencyConfiguration) Reset() {
	*x = OutputPathPersistencyConfiguration{}
	mi := &file_github_com_buildbarn_bb_clientd_pkg_proto_configuration_bb_clientd_bb_clientd_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*OutputPathPersistencyConfiguration) Descriptor() ([]byte, []int) {
	return file_github_com_buildbarn_bb_clientd_pkg_proto_configuration_bb_clientd_bb_clientd_proto_rawDescGZIP(), []int{1}
}
...
var File_github_com_buildbarn_bb_clientd_pkg_proto_configuration_bb_clientd_bb_clientd_proto protoreflect.FileDescriptor
...
var (
	file_github_com_buildbarn_bb_clientd_pkg_proto_configuration_bb_clientd_bb_clientd_proto_rawDescOnce sync.Once
	file_github_com_buildbarn_bb_clientd_pkg_proto_configuration_bb_clientd_bb_clientd_proto_rawDescData []byte
)

func file_github_com_buildbarn_bb_clientd_pkg_proto_configuration_bb_clientd_bb_clientd_proto_rawDescGZIP() []byte {
	file_github_com_buildbarn_bb_clientd_pkg_proto_configuration_bb_clientd_bb_clientd_proto_rawDescOnce.Do(func() {
		file_github_com_buildbarn_bb_clientd_pkg_proto_configuration_bb_clientd_bb_clientd_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_github_com_buildbarn_bb_clientd_pkg_proto_configuration_bb_clientd_bb_clientd_proto_rawDesc), len(file_github_com_buildbarn_bb_clientd_pkg_proto_configuration_bb_clientd_bb_clientd_proto_rawDesc)))
	})
	return file_github_com_buildbarn_bb_clientd_pkg_proto_configuration_bb_clientd_bb_clientd_proto_rawDescData
}

var file_github_com_buildbarn_bb_clientd_pkg_proto_configuration_bb_clientd_bb_clientd_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_github_com_buildbarn_bb_clientd_pkg_proto_configuration_bb_clientd_bb_clientd_proto_goTypes = []any{
...
func init() {
	file_github_com_buildbarn_bb_clientd_pkg_proto_configuration_bb_clientd_bb_clientd_proto_init()
}
func file_github_com_buildbarn_bb_clientd_pkg_proto_configuration_bb_clientd_bb_clientd_proto_init() {
	if File_github_com_buildbarn_bb_clientd_pkg_proto_configuration_bb_clientd_bb_clientd_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_github_com_buildbarn_bb_clientd_pkg_proto_configuration_bb_clientd_bb_clientd_proto_rawDesc), len(file_github_com_buildbarn_bb_clientd_pkg_proto_configuration_bb_clientd_bb_clientd_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_github_com_buildbarn_bb_clientd_pkg_proto_configuration_bb_clientd_bb_clientd_proto_goTypes,
		DependencyIndexes: file_github_com_buildbarn_bb_clientd_pkg_proto_configuration_bb_clientd_bb_clientd_proto_depIdxs,
		MessageInfos:      file_github_com_buildbarn_bb_clientd_pkg_proto_configuration_bb_clientd_bb_clientd_proto_msgTypes,
	}.Build()
	File_github_com_buildbarn_bb_clientd_pkg_proto_configuration_bb_clientd_bb_clientd_proto = out.File
	file_github_com_buildbarn_bb_clientd_pkg_proto_configuration_bb_clientd_bb_clientd_proto_goTypes = nil
	file_github_com_buildbarn_bb_clientd_pkg_proto_configuration_bb_clientd_bb_clientd_proto_depIdxs = nil
}
