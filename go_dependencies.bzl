...
def go_dependencies():
    ...
    go_repository(
        ...
        sum = "h1:+KaKNRrMp7bRjLS4BFY0PNHkZnjczh1O5dV2875tVQE=",
        version = "v0.0.0-20220214204803-78e082c67939",
    )
    go_repository(
        name = "com_github_buildbarn_bb_storage",
        importpath = "github.com/buildbarn/bb-storage",
        patches = ["//:patches/com_github_buildbarn_bb_storage/no-incompatible-platforms.diff"],
        sum = "h1:x09IPVeSu9AFx8UZc3iu6oLfZrEXj2hQ6zz24oijpfs=",
        version = "v0.0.0-20220214182059-9ffa9a3020c5",
    )
    go_repository(
